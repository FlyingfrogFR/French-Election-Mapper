...
2. Cherche sur la période : site de campagne et site du parti (actualités, communiqués, propositions, nouveau programme ou nouvelle version), discours publiés, tribunes signées, propositions de loi et de résolution déposées ou cosignées et votes solennels si la personne est parlementaire (données ouvertes de l'Assemblée et du Sénat ; sur les mesures exactes des affirmations seulement), profession de foi. La presse sert uniquement à repérer ce qui a été publié (requêtes du type « ${c.name} propose », « ${c.name} programme », « ${c.name} discours », avec les mois de la période) ; remonte ensuite au document officiel.
